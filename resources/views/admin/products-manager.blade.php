...
<div class="container_cater-manager">
    ...
    <div class="search-box">
        ...
        <div class="new-catergory">
            <button type="button" class="button">
                <a class="light-text" onclick="showTab('addProduct')"> Add new product</a>
            </button>
        </div>
    </div> <!-- thanh search-->
        ...
        <table id="productTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $product->stock }}</td>
                    <td>
                        <button class="edit-button" onclick="showTab('detailProduct', '{{ json_encode($product) }}','{{ json_encode($categories) }}','{{ json_encode($promotions) }}')">Chỉnh sửa</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
    ...
    <div id="detailProduct" class="tab">
        <div class="modal-content">
            ...
            <form id="updateproductForm"  class="form_add-product">
                ...
                <div class="confirm">
                    <button type="submit" class="button light-text">Xác nhận gửi</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <form id="productForm" class="form_add-product">
                <div class="wrap_input">
                    ...
                    <div class="input" for="brandProduct">
                        ...
                        <input type="text" id="brandProduct" name="bandProduct" class="input_lable" placeholder="Nhập thương hiệu sản phẩm" required>
                    </div>
                    ...
                    <div class="input" for="promotionProduct">
                        ...
                        <select type="text" id="promotionProduct" name="promotionProduct" class="input_lable" required>
